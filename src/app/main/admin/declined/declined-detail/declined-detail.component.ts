...
@Component({
    selector   : 'declined-detail',
    templateUrl: './declined-detail.component.html',
    styleUrls  : ['./declined-detail.component.scss']
})
export class DeclinedDetailComponent implements OnInit
{
